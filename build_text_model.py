...
def main():
    # Load data
    X, y = load_data(r'C:\Users\venka\Downloads\PhishShield-testing\PhishShield-testing\datafiles\dataset_for_text_model.csv')
    ...
    if best_model is not None:
        joblib.dump(best_model, r'C:\Users\venka\Downloads\PhishShield-testing\PhishShield-testing\models\text_model.joblib')
